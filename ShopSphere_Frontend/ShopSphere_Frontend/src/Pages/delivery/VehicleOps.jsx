...
export default function DeliveryVehicleOps() {
    ...
    return (
        <div className={`min-h-screen flex items-center justify-center p-6 relative overflow-hidden transition-colors duration-500 ${isDarkMode ? 'bg-[#0f172a]' : 'bg-[#f8fafc]'}`}>
            ...
            <div className={`absolute top-0 left-0 w-[600px] h-[600px] rounded-full -translate-x-1/2 -translate-y-1/2 blur-[120px] pointer-events-none transition-opacity duration-1000 ${isDarkMode ? 'bg-indigo-500/10 opacity-100' : 'bg-indigo-500/5 opacity-50'}`}></div>
            ...
            <div className="w-full max-w-3xl relative z-10 animate-fadeInUp">
                <div className="mb-12 text-center">
                    <div className={`inline-flex items-center gap-3 px-5 py-2.5 rounded-2xl mb-8 border transition-all ${isDarkMode ? 'bg-white/5 border-white/10' : 'bg-white border-slate-200 shadow-sm'}`}>
                        ...
                        <span className={`text-[10px] font-black uppercase tracking-[4px] ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Logistics Parameters</span>
                    </div>
                    ...
                    <p className={`font-bold text-[11px] uppercase tracking-[3px] italic transition-colors ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>Step 3: Define your operational radius & equipment</p>
                </div>
                ...
                <div className={`backdrop-blur-3xl rounded-[48px] p-10 md:p-14 shadow-2xl relative overflow-hidden border transition-all duration-500 ${isDarkMode ? 'bg-white/5 border-white/10' : 'bg-white border-slate-100 shadow-slate-200'}`}>
                    ...
                    <form onSubmit={handleNext} className="space-y-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="relative group">
                                    ...
                                    <select
                                        ...
                                        className={`w-full pl-16 pr-8 py-5 rounded-[24px] border-2 font-black italic outline-none transition-all shadow-inner appearance-none cursor-pointer ${isDarkMode ? 'bg-[#020617] border-transparent focus:border-orange-500 text-white focus:bg-black/40' : 'bg-slate-50 border-slate-100 focus:border-orange-400 text-slate-900 focus:bg-white'}`}
                                    >
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group">
                                ...
                                <textarea
                                    ...
                                    className={`w-full pl-16 pr-8 py-5 rounded-[28px] border-2 font-black italic outline-none transition-all resize-none shadow-inner ${isDarkMode ? 'bg-[#020617] border-transparent focus:border-orange-500 text-white focus:bg-black/40 placeholder:text-slate-600' : 'bg-slate-50 border-slate-100 focus:border-orange-400 text-slate-900 focus:bg-white placeholder:text-slate-300'}`}
                                />
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
                            <div className="space-y-4">
                                <label className={`text-[9px] font-black uppercase tracking-[3px] ml-1 flex items-center gap-2 italic transition-colors ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>City</label>
                                <input
                                    type="text"
                                    name="city"
                                    required
                                    value={formData.city}
                                    onChange={handleChange}
                                    className={`w-full px-8 py-5 rounded-[24px] border-2 font-black italic outline-none transition-all shadow-inner ${isDarkMode ? 'bg-[#020617] border-transparent focus:border-orange-500 text-white focus:bg-black/40' : 'bg-slate-50 border-slate-100 focus:border-orange-400 text-slate-900 focus:bg-white'}`}
                                />
                            </div>
                            <div className="space-y-4">
                                <label className={`text-[9px] font-black uppercase tracking-[3px] ml-1 flex items-center gap-2 italic transition-colors ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>State</label>
                                <input
                                    type="text"
                                    name="state"
                                    required
                            ...
                            <div className="space-y-4 col-span-2 md:col-span-1">
                                <label className={`text-[9px] font-black uppercase tracking-[3px] ml-1 flex items-center gap-2 italic transition-colors ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>Zip Code</label>
                                <input
                                    type="text"
                                    name="postalCode"
                                    required
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                            <div className="space-y-4">
                                <label className={`text-[9px] font-black uppercase tracking-[3px] ml-1 flex justify-between italic transition-colors ${isDarkMode ? 'text-slate-500' : 'text-slate-400'}`}>
                        ...
                        <button
                            type="submit"
                            className={`w-full py-6 rounded-[32px] text-[11px] font-black uppercase tracking-[5px] shadow-2xl transition-all flex items-center justify-center gap-4 group italic border-none cursor-pointer ${isDarkMode ? 'bg-white text-[#0f172a] hover:bg-indigo-600 hover:text-white shadow-white/5' : 'bg-slate-900 text-white hover:bg-indigo-600 shadow-slate-900/10'}`}
                        >
