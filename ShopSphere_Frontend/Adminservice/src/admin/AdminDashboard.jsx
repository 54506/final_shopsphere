                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-right hidden sm:block">
                                <p className={`text-[10px] font-black uppercase tracking-wider ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>{adminUsername}</p>
                        ...
                        <div className="relative rounded-[2.5rem] overflow-hidden p-8 md:p-12">
                            ...
                            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                                <div className="text-center md:text-left">
                                    ...
                                    <h2 className={`text-3xl md:text-4xl font-black tracking-tighter mb-4 ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Welcome, {adminUsername}</h2>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className={`w-36 h-32 rounded-[2.5rem] border flex flex-col items-center justify-center transition-all ${isDarkMode ? 'bg-slate-900/50 border-slate-800' : 'bg-white border-slate-100 shadow-sm'}`}>
                                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1">Settled Orders</p>
                                        <p className={`text-xl font-black ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'}`}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                            ...
                            >
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-black tracking-tight text-white">Vendors</h3>
                                        <p className="text-[10px] text-indigo-200 font-bold uppercase tracking-widest">Governance</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button onClick={() => navigate('/vendors/requests')} className="bg-white text-indigo-600 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-[1.02] transition-all shadow-lg active:scale-95">Approvals</button>
                                    <button onClick={() => navigate('/vendors')} className="bg-indigo-500 text-white py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-indigo-400 transition-all border border-indigo-400/30 active:scale-95">Directory</button>
                                </div>
                            </Motion.div>
                            ...
                            >
                                <div className="flex items-center gap-4 mb-8">
                                    ...
                                    <div>
                                        <h3 className={`text-xl font-black tracking-tight ${isDarkMode ? 'text-white' : 'text-white'}`}>Customer Access</h3>
                                        <p className={`text-[10px] font-bold uppercase tracking-widest ${isDarkMode ? 'text-emerald-500/60' : 'text-emerald-100'}`}>Governance</p>
                                    </div>
                                </div>
                                ...
                                <button onClick={() => navigate('/users')} className={`w-full py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all shadow-lg active:scale-95 ${isDarkMode ? 'bg-emerald-600 text-white hover:bg-emerald-500' : 'bg-white text-emerald-600 hover:scale-[1.02]'}`}>Advanced Controls</button>
                            </Motion.div>
                            ...
                            >
                                <div className="flex items-center gap-4 mb-8">
                                    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border ${isDarkMode ? 'bg-indigo-500/10 border-indigo-500/20 text-indigo-400' : 'bg-slate-50 border-slate-200 text-slate-800'}`}>
                                        <Zap className="w-6 h-6" />
                                    </div>
                                    <div>
                                        <h3 className={`text-xl font-black tracking-tight ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>Logistics Fleet</h3>
                                        <p className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Global Network</p>
                                    </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <button onClick={() => navigate('/delivery/requests')} className={`py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all active:scale-95 ${isDarkMode ? 'bg-slate-800 text-white hover:bg-slate-700' : 'bg-slate-900 text-white hover:bg-slate-800 shadow-lg'}`}>Review</button>
