        ...
        return (
            <div className={`flex h-screen items-center justify-center ${dm ? 'bg-[#0f172a]' : 'bg-gray-50'}`}>
                <div className="text-center space-y-4">
                    ...
                    <button onClick={() => navigate('/vendors')} className="text-violet-400 hover:underline font-medium">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                ...
                                <h1 className={`text-xl font-bold tracking-tight ${dm ? 'text-white' : 'text-slate-900'}`}>Vendor Profile</h1>
                            </div>
                            ...
                            <div className="p-4 md:p-8">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10 mb-12">
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border min-h-[100px] ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            ...
                                            <p className={`text-sm font-bold uppercase tracking-tight mb-2 ${dm ? 'text-white' : 'text-slate-900'}`}>{vendor.shop_name}</p>
                                            <p className={`text-xs leading-relaxed italic ${dm ? 'text-slate-400' : 'text-slate-500'}`}>{vendor.shop_description || 'No description provided'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${dm ? 'text-slate-500' : 'text-slate-400'}`}>Category & Fee</p>
                                            <p className={`text-sm font-bold uppercase tracking-tight mb-1 ${dm ? 'text-white' : 'text-slate-900'}`}>{vendor.business_type}</p>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${dm ? 'text-slate-500' : 'text-slate-400'}`}>Tax Identifiers</p>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${dm ? 'text-slate-500' : 'text-slate-400'}`}>Beneficiary & Holder</p>
                                            <p className={`text-sm font-bold uppercase tracking-tight mb-1 ${dm ? 'text-white' : 'text-slate-900'}`}>{vendor.bank_holder_name || 'N/A'}</p>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${dm ? 'text-slate-500' : 'text-slate-400'}`}>Account / IFSC</p>
                                            <p className={`text-sm font-mono font-bold tracking-tighter uppercase whitespace-nowrap mb-1 ${dm ? 'text-white' : 'text-slate-900'}`}>{vendor.bank_account_number || 'N/A'}</p>
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className={`p-4 rounded-xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                            <p className={`text-[10px] font-black uppercase tracking-widest mb-1 ${dm ? 'text-slate-500' : 'text-slate-400'}`}>Physical Address</p>
                                ...
                                <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 py-8 border-t mb-8 ${dm ? 'border-slate-700/50 text-slate-200' : 'border-slate-100 text-slate-900'}`}>
                                    <div className={`flex items-center gap-5 p-4 rounded-2xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                        ...
                                        <div>
                                            <p className={`text-sm font-black uppercase tracking-tight ${dm ? 'text-white' : 'text-slate-900'}`}>{vendor.id_type || 'ID Proof'}</p>
                                    ...
                                    <div className={`flex items-center gap-5 p-4 rounded-2xl border ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-slate-50 border-slate-100'}`}>
                                        ...
                                        <div>
                                            <p className={`text-sm font-black uppercase tracking-tight ${dm ? 'text-white' : 'text-slate-900'}`}>PAN Physical Card</p>
                                    ...
                                    <thead className={`border-b ${dm ? 'bg-slate-800/50 border-slate-700/50' : 'bg-[#FBFCFD] border-slate-100'}`}>
                                        <tr>
                                            {['Product', 'Category', 'Price', 'Quantity', 'Status', 'Actions'].map((h, i) => (
                                                <th key={h} className={`px-6 py-4 text-[10px] font-black uppercase tracking-widest ${dm ? 'text-slate-500' : 'text-slate-400'} ${i === 3 || i === 4 ? 'text-center' : ''} ${i === 5 ? 'text-right' : ''}`}>{h}</th>
                                            ))}
                                        </tr>
                                    </thead>
                                                ...
                                                <tr key={product.id} className={`transition-colors group ${dm ? 'hover:bg-slate-700/30' : 'hover:bg-slate-50/50'}`}>
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                <p className={`text-sm font-bold leading-tight uppercase tracking-tight ${dm ? 'text-slate-200' : 'text-slate-800'}`}>{product.name}</p>
                                                                <p className="text-[9px] font-black text-slate-400 uppercase italic">ID: {product.id}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td className={`px-6 py-4 text-[10px] font-black uppercase tracking-widest ${dm ? 'text-slate-400' : 'text-slate-500'}`}>{product.category}</td>
                                                    <td className={`px-6 py-4 text-sm font-black ${dm ? 'text-slate-200' : 'text-slate-900'}`}>
                        ...
                        >
                            ...
                            <div className={`w-full md:w-1/2 p-8 flex flex-col ${dm ? 'bg-[#1e293b]' : 'bg-white'}`}>
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className={`text-xl font-black flex items-center gap-2 ${dm ? 'text-white' : 'text-slate-900'}`}>
                                ...
                                <div className="space-y-6 flex-1 overflow-y-auto pr-2 scrollbar-hide">
                                    ...
                                    <div className={`pt-6 border-t ${dm ? 'border-slate-700/50' : 'border-slate-100'}`}>
                                        <p className={`text-[10px] font-black uppercase tracking-widest mb-3 ${dm ? 'text-slate-500' : 'text-slate-300'}`}>Seller</p>
                                ...
                                <button
                                    onClick={() => setSelectedProduct(null)}
                                    className={`w-full py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all mt-8 ${dm ? 'bg-slate-700 text-white hover:bg-slate-600' : 'bg-slate-900 text-white hover:bg-slate-800 shadow-xl shadow-slate-200'}`}
                                >
                                    Dismiss Profile
                                </button>
                            </div>
